...
private _AGrpUnits = units _ClstGrp;

private _AmmoArray = getArtilleryAmmo _AGrpUnits;
...
private _ContinueFiring = (getPos _LeaderE) inRangeOfArtillery [_ArtilleryGroupActual,_RandomAmmoArray];
